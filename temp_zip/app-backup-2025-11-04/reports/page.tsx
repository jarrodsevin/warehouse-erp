...
const reports = [
  {
    ...
    description: 'Individual product margin and profit analysis',
  ...
  },
  {
    ...
    description: 'Detailed subcategory performance review',
  ...
  },
  {
    ...
    description: 'Brand performance across categories',
  ...
  },
  {
    ...
    description: 'Customer profitability and sales trends',
  ...
  },
  {
    ...
    description: 'Pricing strategy and discount impact',
        ...
        {reports.map((report) => (
          ...
          >
            <div className="flex items-start space-x-4">
              <div className="w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center text-gray-600 flex-shrink-0 group-hover:bg-primary-50 group-hover:text-primary-600 transition-colors">
                {report.icon}
              </div>
