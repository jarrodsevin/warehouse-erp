    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600">Organize your product categories</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Link href="/admin/categories/view" className="group">
            <div className="bg-white border border-gray-200 rounded-lg p-10 hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer h-full">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 group-hover:text-primary-600">
                View Categories
              </h2>
              <p className="text-gray-600">
