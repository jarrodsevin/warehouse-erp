  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-12">Select a purchase order to edit</p>

        <div className="space-y-4">
          {purchaseOrders.map((po) => (
            <div key={po.id} className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 text-sm mb-1">Order Date: {new Date(po.orderDate).toLocaleDateString()}</p>
                ...
                <Link 
                  ...
                  className="bg-blue-600 text-gray-900 px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                >
                  Edit
                </Link>
              </div>
        ...
        {purchaseOrders.length === 0 && (
          <p className="text-center text-gray-600 mt-8">No purchase orders found. Create one first!</p>
        )}
      </div>
    </div>
  )
